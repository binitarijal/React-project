...
const Register = () => {
  ...
  <div className="mb-4">
    ...
    <input type="text" id="username" className="bg-blue-100 border border-blue-300 text-blue-900 text-sm rounded-lg focus:ring-blue-400 focus:border-blue-400 block w-full p-2.5 dark:bg-blue-800 dark:border-blue-600 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required />
  </div>
